...
try:
    from flask_ckeditor_edit.fields import CKEditorField  # noqa
except ImportError:
    warnings.warn('Flask-WTF or WTForms is not installed, CKEditorField will not be available.')
from flask_ckeditor_edit.utils import get_url, random_filename  # noqa
...
def upload_success(url, filename='', message=None):
    ...
    For example::
        ...
        from flask import send_from_directory
        from flask_ckeditor_edit import upload_success
...
def upload_fail(message=None):
    ...
    For example::
        ...
        from flask import send_from_directory
        from flask_ckeditor_edit import upload_success, upload_fail
